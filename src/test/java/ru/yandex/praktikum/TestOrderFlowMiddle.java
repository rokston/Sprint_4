...
import ru.yandex.praktikum.page_object_package.OrderPageFirst;
import ru.yandex.praktikum.page_object_package.OrderPageSecond;
...
public class TestOrderFlowMiddle {
    ...
    //конструктор
    public TestOrderFlowMiddle(String name, String surname, String address, String station,
